...
/* the header files are included for cross_compile
...
CS_INLINE  cs_status  CS_SEM_INIT(CS_SEM * sem_id) 
{
  ...
  /* *sem_id = SEM_CREATE("Palermo Sem", 1); */
